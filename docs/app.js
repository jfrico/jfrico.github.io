...
{
	if (region.L.B === region.S.B)
	{
		return 'on line ' + region.L.B;
	}
	return 'on lines ' + region.L.B + ' through ' + region.S.B;
}
...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try {
			xhr.open(request.aF, request.aT, true);
		} catch (e) {
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {U: fragment, X: host, _: path, ab: port_, ae: protocol, af: query};
	});
...
var $author$project$About$GotDescription = function (a) {
	return {$: 1, a: a};
};
...
var $elm$http$Http$request = function (r) {
	return $elm$http$Http$command(
		$elm$http$Http$Request(
			{au: false, aw: r.aw, aA: r.aA, V: r.V, aF: r.aF, aQ: r.aQ, ao: r.ao, aT: r.aT}));
};
var $elm$http$Http$get = function (r) {
	return $elm$http$Http$request(
		{aw: $elm$http$Http$emptyBody, aA: r.aA, V: _List_Nil, aF: 'GET', aQ: $elm$core$Maybe$Nothing, ao: $elm$core$Maybe$Nothing, aT: r.aT});
};
var $elm$json$Json$Decode$string = _Json_decodeString;
var $author$project$About$loadDescription = function (baseUrl) {
	return $elm$http$Http$get(
		{
			aA: A2(
				$elm$http$Http$expectJson,
				$author$project$About$GotDescription,
				A2($elm$json$Json$Decode$field, 'description', $elm$json$Json$Decode$string)),
			aT: $elm$core$String$concat(
				_List_fromArray(
					[baseUrl, '/api/about.json']))
		});
};
var $author$project$About$init = function (baseUrl) {
	return _Utils_Tuple2(
		{N: 'About', P: baseUrl, A: 'About Page'},
		$author$project$About$loadDescription(baseUrl));
};
var $author$project$Home$GotGreetings = function (a) {
	return {$: 1, a: a};
};
var $author$project$Home$loadGreeting = function (baseUrl) {
	return $elm$http$Http$get(
		{
			aA: A2(
				$elm$http$Http$expectJson,
				$author$project$Home$GotGreetings,
				A2($elm$json$Json$Decode$field, 'greeting', $elm$json$Json$Decode$string)),
			aT: $elm$core$String$concat(
				_List_fromArray(
					[baseUrl, '/api/hello.json']))
		});
};
var $author$project$Home$init = function (baseUrl) {
	return _Utils_Tuple2(
		{P: baseUrl, A: 'welcome home!~'},
		$author$project$Home$loadGreeting(baseUrl));
};
		...
		return $elm$url$Url$Parser$getFirstMatch(
			parser(
				A5(
					...
					_List_Nil,
					$elm$url$Url$Parser$preparePath(url._),
					$elm$url$Url$Parser$prepareQuery(url.af),
					url.U,
					$elm$core$Basics$identity)));
	});
var $author$project$Main$AboutRoute = 1;
	...
	function (model, _v0) {
		...
		return _Utils_Tuple2(
			_Utils_update(
				model,
				{
					p: $author$project$Main$AboutPage(about)
				}),
			A2($elm$core$Platform$Cmd$map, $author$project$Main$GotAboutMsg, msg));
	});
	...
	function (model, _v0) {
		...
		return _Utils_Tuple2(
			_Utils_update(
				model,
				{
					p: $author$project$Main$HomePage(home)
				}),
			A2($elm$core$Platform$Cmd$map, $author$project$Main$GotHomeMsg, msg));
	});
		...
		if (!_v0.$) {
			if (!_v0.a) {
				...
				return A2(
					...
					model,
					$author$project$Home$init(model.P));
			} else {
				var _v2 = _v0.a;
				return A2(
					$author$project$Main$toAbout,
					model,
					$author$project$About$init(model.P));
			}
		} else {
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{p: $author$project$Main$NotFound}),
				$elm$core$Platform$Cmd$none);
		}
	});
var $author$project$Main$init = F3(
	function (baseUrl, url, key) {
		return A2(
			$author$project$Main$updateUrl,
			url,
			{P: baseUrl, G: key, p: $author$project$Main$NotFound});
	});
			...
			case 2:
				...
				if (!_v2.$) {
					...
					return A2(
						$author$project$Main$toHome,
						model,
						A2($author$project$Home$update, homeMsg, str));
				} else {
					return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
				}
			default:
				...
				if (_v3.$ === 1) {
					...
					return A2(
						$author$project$Main$toAbout,
						model,
						A2($author$project$About$update, aboutMsg, str));
				} else {
					return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
				}
		}
...
var $author$project$Main$viewHeader = A2(
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					A3($elm$html$Html$Lazy$lazy2, $author$project$Main$viewLink, '/', 'Home'),
					A3($elm$html$Html$Lazy$lazy2, $author$project$Main$viewLink, '/about', 'About')
				]))
		]));
		...
		switch (_v0.$) {
			...
			case 1:
				...
				return A2(
					...
					$author$project$About$view(about));
			default:
				return $elm$html$Html$text('404 Not Found!');
		}
	}();
	return {
		aw: _List_fromArray(
...
var $author$project$Main$main = $elm$browser$Browser$application(
	{
		...
		aH: $author$project$Main$UrlChanged,
		aI: $author$project$Main$LinkClicked,
		aP: function (_v0) {
